...
const String GMAIL_USER_NAME = "arduino.taiwan@gmail.com";

// your Gmail App-Specific Password
const String GMAIL_PASSWORD = "okczxuvntybdtadm";
...
void loop()
{
    ...
    // send message to gmail
            ...
            if (!success) {
              ...
              SendEmailChoreo.addInput("MessageBody", "Test capture picture and send mail to user !");
